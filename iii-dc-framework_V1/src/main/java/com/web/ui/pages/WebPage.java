...
/**
 * Base SierraWeb page class. All web-pages (and frames) will be inherited from
 * this class
 * 
 * @author Kostiantyn Rybak
 *
 */
public abstract class WebPage extends WebObjectsContainer<WebDriver> 
{
	...
	public boolean waitForPageLoading(int milliseconds) 
	{
	...
	protected boolean waitForLoadingDisappearsFromBodyClass() {
		try {
