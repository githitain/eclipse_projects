...
public class Internationlization_test2 
{
 ...
 /*  for(WebElement item : allFormChildElements )
    ...
    for(WebElement sp1 : allspan )
    {
    	if(sp1.getTagName().equals("span")) 
        {
        	System.out.println("div span value: " + sp1.getAttribute("text")); 
    ...
    List<WebElement> allspan1= driver.findElements(By.xpath("//span"));
    
    System.out.println("Size from evalution:" +allspan1.size());
    
    for(WebElement sp1 : allspan1 )
    {
    	if(sp1.getTagName().equals("span")) 
        {
        	System.out.println("div span value: " + sp1.getAttribute("text")); 
