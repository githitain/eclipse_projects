...
//import test.data.Facet;
import test.ui.objects.AdvancedSearchObjects.CurrentRefinementsBlock;
import test.ui.objects.FacetBlock;
import test.data.Facet;
...
public class SearchPage extends EncoreMainPage 
{
	    ...
	    public FacetBlock getFacetBlock(Facet facet) {
	        return new FacetBlock(this, facet.getName());
	    }
